...
def get_or_create_job_automation_settings(
    ...
    return _map_job_automation_settings_record(row), bool(insert_result.rowcount)
...
def update_job_automation_enabled(
    ...
    *,
    ...
    return _map_job_automation_settings_record(row)
...
def _map_job_automation_settings_record(row) -> JobAutomationSettingsRecord:
